...
resource "oci_database_exadb_vm_cluster" "ExampleExadbVmCluster" {
  #Required
...
data "oci_database_exadb_vm_clusters" "ExampleExadbVmCluster" {
  #Required
  compartment_id = var.compartment_id
  #Optional
  exascale_db_storage_vault_id = oci_database_exascale_db_storage_vault.test_exascale_db_storage_vault.id 
...
data "oci_database_exadb_vm_cluster" "ExampleExadbVmCluster" {
  #Required
  exadb_vm_cluster_id = oci_database_exadb_vm_cluster.ExampleExadbVmCluster.id
}
